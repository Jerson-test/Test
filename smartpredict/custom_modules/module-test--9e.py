...
configuration = {
    ...
    # You can also create as many output as you want
    'out': {
        'result': {
...
# This is a normalized function, it must take "in_data" and "param" as dictionaries as parameter.
def custom_module_function(in_data: dict, param: dict) -> dict:
    ...
    # The output of your function must be a "out_data" mapping dictionary, each key is as specified in configuration
    out_data = {
        'result': result,
    }
